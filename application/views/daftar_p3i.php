...
<body>
  <div class="container-fluid">
    ...
    <?= form_open_multipart('pendaftaran/daftar_p3i') ?>
    <!-- 
      <form role="form" method="POST" action="<?php // echo site_url('pendaftaran/daftar_p3i'); 
    ...
    <div class="container" style="background-color: white;">
      ...
      <input type="radio" id="male" name="kategori" value="dosen" required>
      <label for="male">Dosen</label><br>
      <input type="radio" id="female" name="kategori" value="mahasiswa" required>
      ...
      <input type="text" class="form-control" placeholder="Masukkan H-Index Scopus anda" name="hindex">
