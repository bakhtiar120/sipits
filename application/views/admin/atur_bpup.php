                ...
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            ...
                            <h1>Data Pengusul Beasiswa Pascasarjana untuk Peneliti</h1>
                        </div>
                        <div class="col-sm-6">
                        ...
                        <?php echo $this->session->flashdata("hasil_bpup"); ?>
                    </div>
                </div><!-- /.container-fluid -->
            </section>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            ...
                            <div class="row">
                                ...
                                <div class="col-2" style="margin-top: 25px;"><a class="btn btn-info btn-sm" href="<?php echo site_url('atur_bpup/cetak_excel'); ?>">
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($data as $key => $value) : ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-primary btn-sm" href="<?php echo site_url('atur_bpup/detail/' . $value['id_bpup']); ?>">
