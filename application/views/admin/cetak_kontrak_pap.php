...
$pdf->Cell(2);
$pdf->Ln(2);
$pdf->Cell(0, 2, 'Nomor : ' . $nomor_kontrak, 0, 1, 'C');
$pdf->Ln(6);
$pdf->SetFont('Times', '', '10');
$pdf->Cell(0, 2, 'Pada hari ini, tanggal '.terbilang(tgl_aja($tanggal_kontrak)). ', bulan'.getBulan(bln_aja($tanggal_kontrak)). ', tahun '.terbilang(thn_aja($tanggal_kontrak)). ' yang bertandatangan di bawah ini:', 0, 1, '');
$pdf->Ln(3);
$pdf->setX(15);
...
$pdf->Cell(0, -2, ':', 0, 1, '');
$pdf->setX(45);
$pdf->Cell(0, 2, $nomor_induk_ketua, 0, 1, '');
$pdf->Ln(3);
$pdf->setX(15);
...
$pdf->Cell(0, -2, ':', 0, 1, '');
$pdf->setX(45);
$pdf->Cell(0, 2, $departemen_ketua, 0, 1, '');
$pdf->Ln(3);
$pdf->setX(15);
...
$pdf->Cell(0, -2, ':', 0, 1, '');
$pdf->setX(45);
$pdf->Cell(0, 2, $nomor_induk_ap, 0, 1, '');
$pdf->Ln(3);
$pdf->setX(15);
$pdf->Cell(0, 2, 'Departemen', 0, 1, '');
$pdf->setX(42);
$pdf->Cell(0, -2, ':', 0, 1, '');
$pdf->setX(45);
$pdf->Cell(0, 2, $departemen_ap, 0, 1, '');
$pdf->Ln(3);
$pdf->setX(15);
...
$pdf->Cell(0, -2, ':', 0, 1, '');
$pdf->setX(45);
$pdf->Cell(0, 2, $alamat_ktp_ap, 0, 1, '');
$pdf->Ln(3);
$pdf->setX(15);
...
$pdf->Cell(0, -2, ':', 0, 1, '');
$pdf->setX(45);
$pdf->Cell(0, 2, $alamat_domisili_ap, 0, 1, '');
$pdf->Ln(3);
$pdf->Cell(0, 2, 'Selanjutnya disebut', 0, 1, '');
...
$pdf->Cell(0, -2, ':', 0, 1, '');
$pdf->setX(45);
$pdf->Cell(0, 2, $lama_bulan.' '.$jenis_lama, 0, 1, '');
$pdf->Ln(3);
$pdf->setX(15);
...
$pdf->Cell(0, -2, ':', 0, 1, '');
$pdf->setX(45);
$pdf->Cell(0, 2, rupiah($honor) .' Setiap '.$jenis_lama, 0, 1, '');
$pdf->Ln(3);
$pdf->setX(15);
...
$pdf->Cell(0, -2, ':', 0, 1, '');
$pdf->setX(45);
$pdf->Cell(0, 2, rupiah($total_honor), 0, 1, '');
$pdf->Ln(3);
$pdf->setX(15);
...
$pdf->Cell(0, -2, ':', 0, 1, '');
$pdf->setX(45);
$pdf->Cell(0, 2, terbilang($total_honor), 0, 1, '');
$pdf->Ln(3);
$pdf->Cell(0, 2, '2.', 0, 1, '');
$pdf->SetFont('Times', 'B', '10');
$pdf->setX(15);
...
$pdf->Cell(0, -2, $nama_ap, 0, 1, '');
$pdf->Ln(30);
$pdf->Cell(0, 2, 'NIP. '.$nomor_induk_ketua, 0, 1, '');
$pdf->setX(130);
$pdf->Cell(0, -2, 'NIK. '.$nik_ap, 0, 1, '');
